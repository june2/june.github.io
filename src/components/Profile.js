        ...
        <Row>
          ...
          <Col className="col-12 col-md-9">
            <Row><Col className="mt-1">
              <a href="https://github.com/june2" target="_blank">https://github.com/june2&nbsp;&nbsp;<i class="fa fa-link" aria-hidden="true"></i></a>
            </Col></Row>
          </Col>
          <Col className="col-12 col-md-3 text-md-right">
          ...
          <Col className="col-12 col-md-9">
            <Row><Col className="mt-1">
              <a href="https://www.linkedin.com/in/june4536" target="_blank">https://www.linkedin.com/in/june4536&nbsp;&nbsp;<i class="fa fa-link" aria-hidden="true"></i></a>
            </Col></Row>
          </Col>
        </Row>
      </div>
